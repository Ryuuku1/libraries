using Libraries.Features.Pagination.Exceptions;
using Libraries.Features.Pagination.Validation;
using Microsoft.EntityFrameworkCore;
using Newtonsoft.Json;

namespace Libraries.Features.Pagination
{
    /// <summary>
    ...
    public class PagedList<T>
    {
        ...
        public static PagedList<T> Create(IEnumerable<T> collection, int pageIndex, int pageSize)
        {
            ...
            return new PagedList<T>(pageItems, pageIndex, pageSize, items.Count);
        }
        ...
        )
        {
            ...
            return new PagedList<T>(pageItems.ToList(), pageIndex, pageSize, items.Count);
        }
